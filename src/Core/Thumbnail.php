...
class Thumbnail
{
     ...
     */
    public function acfImg($imgArray = [], $mobileSize = 'medium', $defaultSize = 'large') :string
    {
        if ($imgArray['mime_type'] === 'image/gif') return $imgArray['url'];
        return wp_is_mobile() ?
     ...
     * @return false|string
     */
    public function postImg($post, $mobileSize = 'medium', $defaultSize = 'large') :?string
    {
        return wp_is_mobile() ?
     ...
     * @return false|string
     */
    public function img($wpImgID, $mobileSize = 'medium', $defaultSize = 'large') :?string
    {
        return wp_is_mobile() ?
